...
<script src="https://kit.fontawesome.com/a076d05399.js"></script>
	...
	*{margin: 0; padding: 0;}
	...
	<form action="login1_core.php" method="POST">
	<div class="full">
	  <div class="login">
      <h1>Login Form</h1>
      ...
      <div class="container">
        ...
        <input type="text" placeholder="Enter Username" name="uname1" style="padding:5px;" required><br/><br/>
        <label for="psw"><strong>Password</strong></label>
        <input type="password" placeholder="Enter Password" name="psw1" style="padding:5px;" required><br/><br/>
      </div>
	  <div class="buttond">
